  ...
  },
  {
    ...
    content: (
      <Box>
        ...
        <Box>④の詳細</Box>
        <Box>
          ④が一番Q学習のキモとなる部分です。評価値の更新を数式で表すと次のようになります。
        </Box>
        <Box>
          Q(状態, 移動方向) := Q(状態, 移動方向) + 学習率 × (報酬 + 割引率 ×
          Q(移動後の状態, 移動後の最適移動方向) - Q(状態, 移動方向))
        </Box>
        <Box>
          学習率は現在の評価値をどれほど更新するかの値であり、0.1くらいが良い。割引率は、直近の将来の利益をどれほど重視するかを表す値であり、0.95ほどが良い。
        </Box>
      </Box>
    ),
  },
